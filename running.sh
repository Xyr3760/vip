...
# Author  : XYORUZ
# (C) Copyright 2021-2024 By Xyoruz
# =========================================
...
echo -e "         OWNER : ${GREEN}OTTIN NETWORK ${NC}${YELLOW}(${NC} ${GREEN}XYORUZ ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By XYORUZ ${YELLOW}(${NC} 2021-2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
