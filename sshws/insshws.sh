...
#wget -O /usr/local/bin/ws-openssh https://raw.githubusercontent.com/Xyr3760/v4/main/sshws/openssh-socket.py
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Xyr3760/v4/main/sshws/dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Xyr3760/v4/main/sshws/ws-stunnel
